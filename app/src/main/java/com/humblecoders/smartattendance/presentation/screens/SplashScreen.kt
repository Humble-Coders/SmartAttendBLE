...
fun SplashScreen(
    ...
    var titleOpacity by remember { mutableFloatStateOf(0f) }
    var loadingOpacity by remember { mutableFloatStateOf(0f) }
    var brandingOpacity by remember { mutableFloatStateOf(0f) }

    // Animation progress from 0 to 1
    var iconAnimProgress by remember { mutableFloatStateOf(0f) }
...
private fun lerp(fraction: Float): Float {
    return 0.5f + fraction * (0.0f - 0.5f)
}
